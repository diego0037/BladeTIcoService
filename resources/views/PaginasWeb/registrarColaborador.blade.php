...
@section('title', 'Creando Colaborador')
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="{{ url('busqueda') }}"><span class="glyphicon glyphicon-home"></span> Usuario en sesión</a></li>
      <li><a href="{{ url('registro') }}"><span class="glyphicon glyphicon-user"></span> Salir</a></li>
    </ul>
  </div>
</nav>
...
<div class="form-group  col-md-offset-4 col-md-4 col-md-offset-4">
  {{ Form::label('id_service', 'Nombre de col') }}
